        ...
        this.state = {
            ...
            series: [{
              ...
              },
              {
                ...
                colors: '#2B61E4',
                type: 'bar',
                data: [[new Date('2021-08-15, 8:00 +0800').getTime(),69],
                       [new Date('2021-08-16, 8:00 +0800').getTime(),63], 
                       [new Date('2021-08-17, 8:00 +0800').getTime(),100], 
                       [new Date('2021-08-18, 8:00 +0800').getTime(),63], 
                       [new Date('2021-08-19, 8:00 +0800').getTime(),0], 
                       [new Date('2021-08-20, 8:00 +0800').getTime(),0], 
                       [new Date('2021-08-21, 8:00 +0800').getTime(),100],
                       [new Date('2021-08-22, 8:00 +0800').getTime(),100],
                       [new Date('2021-08-23, 8:00 +0800').getTime(),67],
                       [new Date('2021-08-24, 8:00 +0800').getTime(),73],
                       [new Date('2021-08-25, 8:00 +0800').getTime(),0],
                       [new Date('2021-08-26, 8:00 +0800').getTime(),72],
                       [new Date('2021-08-27, 8:00 +0800').getTime(),96],
                       [new Date('2021-08-28, 8:00 +0800').getTime(),84]]
              },
              {
                name: 'Evening (Reality)',
                colors: '#000B85',
                type: 'bar',
                data: [[new Date('2021-08-15, 10:00 +0800').getTime(),75],
                       [new Date('2021-08-16, 10:00 +0800').getTime(),70], 
                       [new Date('2021-08-17, 10:00 +0800').getTime(),100], 
                       [new Date('2021-08-18, 10:00 +0800').getTime(),96], 
                       [new Date('2021-08-19, 10:00 +0800').getTime(),91], 
                       [new Date('2021-08-20, 10:00 +0800').getTime(),72], 
                       [new Date('2021-08-21, 10:00 +0800').getTime(),100],
                       [new Date('2021-08-22, 10:00 +0800').getTime(),100],
                       [new Date('2021-08-23, 10:00 +0800').getTime(),84],
                       [new Date('2021-08-24, 10:00 +0800').getTime(),62],
                       [new Date('2021-08-25, 10:00 +0800').getTime(),0],
                       [new Date('2021-08-26, 10:00 +0800').getTime(),88],
                       [new Date('2021-08-27, 10:00 +0800').getTime(),96],
                       [new Date('2021-08-28, 10:00 +0800').getTime(),0]]
              }, 
              //{
              //   name: 'Line Sunday 1',
              //   colors: '#000000',
