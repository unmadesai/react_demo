    ...
    constructor(props) {
        ...
        this.state = {
            ...
            series: [{
                ...
                colors: '#81A2EF',
                data: [[new Date('2021-08-15, 09:00 +0800').getTime(),54],
                       [new Date('2021-08-16, 09:00 +0800').getTime(),72], 
                       [new Date('2021-08-17, 09:00 +0800').getTime(),37], 
                       [new Date('2021-08-18, 09:00 +0800').getTime(),19], 
                       [new Date('2021-08-19, 09:00 +0800').getTime(),33], 
                       [new Date('2021-08-20, 09:00 +0800').getTime(),37], 
                       [new Date('2021-08-21, 09:00 +0800').getTime(),22],
                       [new Date('2021-08-22, 09:00 +0800').getTime(),63],
                       [new Date('2021-08-23, 09:00 +0800').getTime(),28],
                       [new Date('2021-08-24, 09:00 +0800').getTime(),76],
                       [new Date('2021-08-25, 09:00 +0800').getTime(),64],
                       [new Date('2021-08-26, 09:00 +0800').getTime(),25],
                       [new Date('2021-08-27, 09:00 +0800').getTime(),29],
                       [new Date('2021-08-28, 09:00 +0800').getTime(),62]]
              },
              {
                name: 'Afternoon (Reality)',
                colors: '#2B61E4',
                data: [[new Date('2021-08-15, 14:00 +0800').getTime(),36],
                       [new Date('2021-08-16, 14:00 +0800').getTime(),65], 
                       ...
                       [new Date('2021-08-23, 14:00 +0800').getTime(),0],
                       [new Date('2021-08-24, 14:00 +0800').getTime(),76],
              ...
              },
              {
                ...
                colors: '#2B61E4',
                data: [[new Date('2021-08-15, 19:00 +0800').getTime(),33],
                       [new Date('2021-08-16, 19:00 +0800').getTime(),0], 
                       [new Date('2021-08-17, 19:00 +0800').getTime(),0], 
                       [new Date('2021-08-18, 19:00 +0800').getTime(),0], 
                       [new Date('2021-08-19, 19:00 +0800').getTime(),0], 
                       [new Date('2021-08-20, 19:00 +0800').getTime(),0], 
                       [new Date('2021-08-21, 19:00 +0800').getTime(),0],
                       [new Date('2021-08-22, 19:00 +0800').getTime(),34],
                       [new Date('2021-08-23, 19:00 +0800').getTime(),13],
                       [new Date('2021-08-24, 19:00 +0800').getTime(),69],
                       [new Date('2021-08-25, 19:00 +0800').getTime(),69],
